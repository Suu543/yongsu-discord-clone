...
export const ChatMessages = ({
  ...
  const updateKey = `chat:${chatId}:messages:update`; // update + delete(delete도 update 방식과 유사하게 동작함)
  ...
  if (status === "error") {
    return (
      <div className="flex flex-col items-center justify-center flex-1">
        <ServerCrash className="my-4 h-7 w-7 text-zinc-500 animate-spin" />
        <p className="text-xs text-zinc-500 dark:text-zinc-400">
